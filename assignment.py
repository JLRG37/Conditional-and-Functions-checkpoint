...
if grade >= 90:
    print("A")
elif grade >= 80 and age <= 89:
    print("B")
elif grade >= 70 and age <= 79:
    print("C")
elif grade >= 60 and age <= 69:
    print("D")
else:
    print("F")
# TASK 7:
...
first_number = input("pick the first whole number that comes to mind: ")
second_number = input("pick the second whole number that comes to mind: ")
third_number = input("pick the third whole number that comes to mind: ")
...
value1 = input("pick the first whole number that comes to mind: ")
value2 = input("pick a second whole number that comes to mind: ")
value3 = input("pick a third whole number that comes to mind: ")
if first_number > (second_number and third_number):
...
# OR
# Not increasing
n1 = input("pick the first whole number that comes to mind: ")
n2 = input("pick the second whole number that comes to mind: ")
n3 = input("pick the third whole number that comes to mind: ")
if n1 < n2 < n3:
    print("Increasing")
else:
...
# All different
# if none match
a = input("pick a whole number that comes to mind: ")
b = input("pick another whole number that comes to mind: ")
c = input("pick another whole number that comes to mind: ")
if a == b == c:
    print("All same")
...
user_score = int(input("Give a score from 0 to 100 "))
...
greet_student("Juan")
greet_student("Johnny")
greet_student("Jessica")
...
find_lowest(23, 467, 53)
find_lowest(3, 5, 4)
find_lowest(34, 42, 90)
...
compare_three(37, 37, 37)
compare_three(37, 37, 47)
compare_three(37, 47, 57)
...
is_in_range(37, 87, 100)
is_in_range(48, 32, 59)
is_in_range(98, 45, 28)
...
highest_result = highest_of_three(37, 21, 4)
...
lowest_result = lowest_of_three(37, 21, 4)
...
if a < b and b < c:
    print("Stricly increasing")
elif a > b and b > c:
    print("Strickly decreasing")
else:
    print("Neither")
...
user_num1 = int(input("Think of a whole number "))
user_num2 = int(input("Think of another whole number "))
user_num3 = int(input("Think of one last whole number "))
...
first = int(input("Think of a number "))
second = int(input("Think of another number "))
third = int(input("Think of a third number "))
...
print(parking_cost(12))
print(parking_cost(9))
print(parking_cost(5))
print(parking_cost(6))
...
print(tips_amount(100, "poor"))
print(tips_amount(100, "good"))
print(tips_amount(100, "excellent"))
print(tips_amount(80, "good"))
